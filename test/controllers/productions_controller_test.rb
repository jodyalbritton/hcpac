...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { description: @production.description, end_date: @production.end_date, start_date: @production.start_date, title: @production.title }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { description: @production.description, end_date: @production.end_date, start_date: @production.start_date, title: @production.title }
    assert_redirected_to production_path(assigns(:production))
  end
